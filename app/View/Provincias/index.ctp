<div class="provincias index">
	...
	<tr>
		...
		<td><?php echo h($provincia['Provincia']['created']); ?>&nbsp;</td>
		<td><?php echo h($provincia['Provincia']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $provincia['Provincia']['id']), array(), __('Are you sure you want to delete # %s?', $provincia['Provincia']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
