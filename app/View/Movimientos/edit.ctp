...
<?php echo $this->Form->create('Movimiento'); ?>
	...
	<?php
		...
		echo $this->Form->input('movimiento');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Movimiento.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Movimiento.id'))); ?></li>
